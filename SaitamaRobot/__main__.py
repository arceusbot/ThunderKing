...
PM_START_TEXT = """
Hi {}, my name is {}! 
I am an Anime themed group management bot Made By @Itz_Mr_Hillarious And  @Developer_boy_sd_owner Made With Love ❤️ Join Support Group @thunderkingsupport .
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yeah , I am now online!")
        except Unauthorized:
            LOGGER.warning(
                "Bot isnt able to send message to support_chat, go and check!")
        except BadRequest as e:
